import os;
# Django settings for bunnyscript project.
...
SECRET_KEY = '*o*wikxga3hndnsy3#t*_%+^f0j7zb%ovo5^u8^$*g=)tw=sta'
...
ROOT_URLCONF = 'bunnyscript.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bunnyscript.wsgi.application'
