...
int main()
{
    ...
    // daí vai precisar imprimir o resultado da escape, mas fazer isso "caracter por caracter".
    // ou seja, ao invés de imprimir a linha toda com sprintf("%s") ou coisa assim,
    // vai dar um loop nela imprimindo um caracter por vez.