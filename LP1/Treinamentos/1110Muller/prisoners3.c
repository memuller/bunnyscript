...
void main()
{
    ...
    int anosPrisao[] = {0,0};
    prisoners(anosPrisao);
    printf("Voce sera preso por %i anos.\n", anosPrisao[0]);
    printf("Seu oponente sera preso por %i anos.\n",anosPrisao[1]);
}

/*
    - ao invés de converter constantemente os valores dos anos de prisão, armazene-os já convertidos 
    em um array de inteiros ao invés de chars;
    - use uma ou mais variáveis globais para armazenar os anos de prisão; NO
    - imprima as ações de cada jogador (trair/cooperar) e os anos de prisão mesma linha, de forma mais compacta. ok
*/